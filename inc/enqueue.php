...
function spanishnova_enqueue_assets() {
    ...
    wp_enqueue_style('spanishnova-taxonomy-grammar', get_template_directory_uri() . '/assets/css/taxonomy-grammar.css', ['spanishnova-main'], '0.1.0');
    wp_enqueue_style('spanishnova-conversations', get_template_directory_uri() . '/assets/css/conversations.css', ['spanishnova-main'], '0.1.0');
